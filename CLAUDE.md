...
I currently get an email from Paypal for every transaction I make with my Paypal debit card. I have to
manually process these transactions for my personal finance spreadsheet.

**Why it matters:**
<!-- What's the deeper purpose? What changes if this succeeds? -->
I will save lots of time if I can automate this process and spend more time with my family.

**What success looks like:**
<!-- Concrete, measurable outcomes. Not features — outcomes. -->
The parsing of the data should be deterministic and reliable. No transactions or data should be missed.
It should be simple enough for me to understand. There should be monitoring or logging so I can cross-check.

**What quality means here:**
<!-- What standard are we holding ourselves to? What's the bar? -->
I should be able to cross-check any email and confirm the data is 100% accurate.

**What this project is NOT:**
<!-- Boundaries. What are we deliberately not doing? What's out of scope? -->
We're not building a SaaS platform. There doesn't even need to be a GUI. This is for one-user. 
It only needs to support individual Paypal account and one Google sheet.
